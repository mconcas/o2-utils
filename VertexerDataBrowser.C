...
void VertexerDataBrowser(const std::string fileName)
{
    ...
    auto canvasLines = new TCanvas("Lines", "Clusters data", 1000, 1000);
    ...
    TH1F *histComb01Phi = new TH1F("hComb01phi", "Comb01 Phi angle", 100, -3.15f, 3.15f);
    TH1F *histComb12Phi = new TH1F("hComb12phi", "Comb12 Phi angle", 100, -3.15f, 3.15f);
    ...
    TH2F *histDelta01Phi1 = new TH2F("hDelta01Phi1", "DeltaPhi 01 vs Phi1", 100, 0.f, 6.29f, 200, -0.5f, 0.5f);
    TH2F *histDelta12Phi1 = new TH2F("hDelta12Phi1", "DeltaPhi 12 vs Phi1", 100, 0.f, 6.29f, 200, -0.5f, 0.5f);
